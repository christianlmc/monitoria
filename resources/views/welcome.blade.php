            	...
            	<div class="row">
		            <div class="panel panel-default col-md-4 nopadding">
		            	...
		            	<div class="panel-body">
			            	<div class="lead">Data de Início: {{ $periodos[0]->inicio }}</div>
			            	<div class="lead">Encerramento: {{ $periodos[0]->fim }}</div>
		            	</div>
					</div>
					 ...
					 <div class="panel panel-default col-md-4 nopadding">
		 				...
		 				<div class="panel-body">
		 					<div class="lead">Data de Início: {{ $periodos[1]->inicio }}</div>
		            		<div class="lead">Encerramento: {{ $periodos[1]->fim }}</div>
					...
					<div class="panel panel-default col-md-4 nopadding">
		            	...
		            	<div class="panel-body">
		            		<div class="lead">Resultado final: {{ $periodos[2]->inicio }}</div>
                            <div class="lead">&nbsp;</div>
		            	</div>
					</div>
                    &nbsp;
